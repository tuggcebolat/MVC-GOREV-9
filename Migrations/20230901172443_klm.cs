        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoryPosts_Categories_PostId",
                        column: x => x.PostId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryPosts_Posts_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PageId1 = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Settings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Settings_Pages_PageId1",
                        column: x => x.PageId1,
            ...
            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "PostId", "Title", "Url" },
                values: new object[,]
                {
                    { 1, "A", "www.tugcebolat.com" },
                    { 2, "B", "www.bolat.com/blog" }
                });
